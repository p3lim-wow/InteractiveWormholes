...
L['Nethergarde Keep'] = 'Forte di Guardiafatua'
L['Aerie Peak'] = 'Picco dell\'Aquila'
L['The Masonary'] = 'Corridoio Oscuro'
L['Shadowforge City'] = 'Forgiascura'
L['Fire Plume Ridge'] = 'Rilievo del Magma Colante'
L['Throne of Flame'] = 'Trono delle Fiamme'
L['The Great Divide'] = 'Grande Fenditura'
L['Fel Pits'] = 'Fosse Vili'
L['Honor Hold'] = 'Rocca dell\'Onore'
L['Skald'] = 'Skald'
L['Argent Tournament Grounds'] = 'Campi del Torneo d\'Argento'
L['Ruby Dragonshrine'] = 'Santuario dei Draghi di Rubino'
L['One Keg'] = 'Mezzabotte'
L['Stormstout Brewery'] = 'Birrificio Triplo Malto'
-- L['Blackrock Foundry Overlook'] = '' -- MISSING TRANSLATION
L['Elemental Plateau'] = 'Altopiano Elementale'
