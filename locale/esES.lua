...
-- tooltips
L['Galebroken Path'] = 'Sendero Rompeciclón' -- AreaTable.db2, id=7611
L['Thorignir Refuge'] = 'Refugio de los Thorignir' -- AreaTable.db2, id=8267
L['Thorim\'s Peak'] = 'Cima de Thorim' -- AreaTable.db2, id=7612
