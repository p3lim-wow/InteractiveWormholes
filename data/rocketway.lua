...
addon.data[39571] = { -- Gallywix Rocketway Exchange
	...
	tooltipArea = addon.data[39597].tooltipArea,
	isTaxi = true,
...
addon.data[39572] = { -- Northern Rocketway Exchange
	...
	tooltipArea = addon.data[39598].tooltipArea,
	isTaxi = true,
...
addon.data[39573] = { -- Northern Rocketway Terminus
	...
	tooltipArea = addon.data[39599].tooltipArea,
	isTaxi = true,
...
addon.data[38780] = { -- Orgrimmar Rocketway Exchange
	...
	tooltipArea = addon.data[39596].tooltipArea,
	isTaxi = true,
...
addon.data[38782] = { -- Southern Rocketway Terminus
	...
	tooltipArea = addon.data[39570].tooltipArea,
	isTaxi = true,
