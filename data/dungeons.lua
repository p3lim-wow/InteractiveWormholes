...
addon.dungeons = {
	...
	[278] = 1254555, -- Path of Unyielding Blight (Pit of Saron)
	...
	[945] = 1254551, -- Path of Dark Dereliction (Seat of the Triumvirate)
	...
	[1030] = 1286828, -- Path of the Sacred Temple (Temple of Sethraliss)
	[1041] = 1286831, -- Path of the Slumbering Conqueror (Kings' Rest)
	...
	[1299] = 1254400, -- Path of the Windrunners (Windrunner Spire)
	...
	[1304] = 1286809, -- Path of the Devious Smuggler (Murder Row)
	[1309] = 1286801, -- Path of the Blooming Verdure (The Blinding Vale)
	[1311] = 1286807, -- Path of the Worthy Aspirant (Den of Nalorakk)
	[1313] = 1286804, -- Path of the Brutal Combatant (Voidscar Arena)
	[1315] = 1254559, -- Path of Cavernous Depths (Maisara Caverns)
	[1316] = 1254563, -- Path of the Fractured Core (Nexus-Point Xenas)
	[1322] = 1286812, -- Path of Venomous Evolution (Altar of Fangs)
}
